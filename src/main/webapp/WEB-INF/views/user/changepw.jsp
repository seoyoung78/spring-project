                        ...
                        <div class="card-signup">
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                                    ...
                                    <div class="input-group form-group" style="margin-bottom:0;">
	                                    <div>
	                                        <input type="text" class="form-control" id="userSsn1" name="userSsn1" placeholder="주민번호 앞자리">
	                                    </div>
	                                    -
                                        <div>
                                            <input type="password" class="form-control" id="userSsn2" name="userSsn2" placeholder="주민번호 뒷자리">
                                        </div>
                                    </div>
